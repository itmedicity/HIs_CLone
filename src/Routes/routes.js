...
// Hospital income report - Typed
const HospitalIncomeReportsTyped = React.lazy(() => import("../views/Pages/Mis/HospitalIncomeTypeTwo/HospitalncomeReports"));
const incomeReportsTyped = React.lazy(() => import("../views/Pages/Mis/HospitalIncomeTypeTwo/IncomeReports"));
...
const routes = [
  ...
  // qmt typed
  {path: "/hospital_income_types", element: HospitalIncomeReportsTyped, name: "Hospital Income Statement"},
  {path: "/income-reports_types", element: incomeReportsTyped, name: "Hospital Income Statement"},
