...
const MenuGroupMapping = () => {
  ...
  const SaveMenuDetails = useCallback(
    (e) => {
  ...
  return (
    <Fragment>
      <ToastContainer />
      {flag === 1 ? (
        <ViewMenuDetails setFlag={setFlag} view={view} setView={setView} EditUser={editView} ClearData={ClearMenuDetails} />
      ) : (
        <Box sx={{display: "flex", flexDirection: "row", justifyContent: "center", width: "100%", pt: 2}}>
          ...
          >
            ...
            >
              ...
              >
                <Typography variant="body1" align="right" style={{fontSize: "12px"}}>
                  Status
                </Typography>
              </Box>
