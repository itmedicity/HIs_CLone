...
const UserRightsApply = () => {
  ...
  const SearchUserRights = useCallback(
    (e) => {
    ...
    <Fragment>
      ...
      <Box sx={{display: "flex", flexDirection: "row", justifyContent: "center", width: "100%", pt: 2}}>
        ...
        >
          ...
          <Box sx={{display: "flex", pt: 1, flexDirection: "row"}}>
            <Box sx={{display: "flex", flexDirection: "row", width: "100%"}}>
              <Box sx={{flex: 1, display: "flex", flexDirection: "row"}}>
                ...
                <Box sx={{display: "flex", pl: 1}}>
                  <ModuleGroupComp value={module} setValue={setModule} />
                </Box>
              </Box>
              ...
              <Box sx={{flex: 1, display: "flex", flexDirection: "row"}}>
                ...
                <Box sx={{display: "flex", pl: 1}}>
                  <UserGroupComp value={usergroup} setValue={setUsergroup} />
                </Box>
              </Box>
            </Box>
          </Box>
          ...
          <Box sx={{display: "flex", flexDirection: "row", width: "100%", pt: 1}}>
            <Box sx={{display: "flex", flexDirection: "row", width: "100%"}}>
              <Box sx={{flex: 1, display: "flex", flexDirection: "row"}}>
                ...
                <Box sx={{display: "flex", pl: 1}}>
                  <MenuGroupComp value={menugroup} setValue={setMenugroup} module={module} />
                </Box>
              </Box>
              <Box sx={{flex: 0.2, display: "flex", flexDirection: "row"}}></Box>
              <Box sx={{flex: 1, display: "flex", flexDirection: "row"}}>
          ...
          {flag === 0 ? (
            <Box sx={{display: "flex", flexDirection: "column", height: "350px"}}></Box>
          ) : (
                ...
                <TableContainer sx={{maxHeight: 350, maxWidth: "100%"}}>
                  ...
                  >
                    <TableHead sx={{height: "40px"}}>
                      ...
                      >
                        <TableCell sx={{fontWeight: "bold", fontSize: 12, backgroundColor: "lightgrey", borderRight: "1px solid lightgrey", pl: 1, borderTop: "1px solid lightgrey", width: 15}}>
                          Sl.No
                        </TableCell>
                        <TableCell sx={{fontWeight: "bold", fontSize: 12, backgroundColor: "lightgrey", borderRight: "1px solid lightgrey", pl: 1, borderTop: "1px solid lightgrey"}}>
                          Menu Group
                        </TableCell>
                        <TableCell sx={{fontWeight: "bold", fontSize: 12, backgroundColor: "lightgrey", borderRight: "1px solid lightgrey", pl: 1, borderTop: "1px solid lightgrey"}}>
                          Menu Name
                        </TableCell>
                        <TableCell sx={{fontWeight: "bold", fontSize: 12, backgroundColor: "lightgrey", borderRight: "1px solid lightgrey", pl: 1, borderTop: "1px solid lightgrey", width: 50}}>
                          {" "}
                          View{" "}
                        </TableCell>
                        <TableCell sx={{fontWeight: "bold", fontSize: 12, backgroundColor: "lightgrey", borderRight: "1px solid lightgrey", pl: 1, borderTop: "1px solid lightgrey", width: 50}}>
