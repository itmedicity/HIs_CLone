...
const ReportModal = ({layout, setLayout, state, data, name}) => {
  ...
  return (
    <Modal open={!!layout} onClose={() => setLayout(undefined)}>
      <ModalDialog aria-labelledby="layout-modal-title" aria-describedby="layout-modal-description" layout={layout} sx={{backgroundColor: reportLength === 0 ? "white" : "lightgrey"}}>
        {reportLength === 0 ? (
          <Box></Box>
        ) : (
          <>
                  ...
                  <Table padding="none" sx={{}} size="small" aria-label="a dense table">
                    ...
                    >
                      ...
                      >
                        ...
                        <TableCell padding="none" variant="body" size="small" align="left" sx={{width: "25%", fontWeight: "bolder", fontSize: "12px", pl: 2}}>
                    ...
                    <TableBody>
                      ...
                      >
                        ...
                        <TableCell align="left" colSpan={3} sx={{fontWeight: "bolder", fontSize: "12px", textTransform: "capitalize"}}>
                          {reportName}
                        </TableCell>
                      </TableRow>
                      {dataArray?.map((e, idx) => (
                    ...
                    <TableFooter>
                      <TableRow>
                        ...
                        <TableCell align="left" sx={{width: "25%", fontSize: "12px", textTransform: "capitalize", fontWeight: 700, color: "black"}}>
                          Total
                        </TableCell>
