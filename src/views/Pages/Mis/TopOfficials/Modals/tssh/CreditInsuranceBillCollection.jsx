...
import {GET_tssh_CreditInsuranceBillCollection} from "../../api/tmch.api";
import {useSearchParams} from "react-router-dom";

const CreditInsuranceBillCollection = () => {
  ...
  useEffect(() => {
    const data = sessionStorage.getItem("CreditInsurnaceBillCollectionTssh");
    if (data) {
  ...
  const {data, isLoading, isError, error} = useQuery({
    queryKey: ["TsshCreditInsurBillCollModal", from, to, ipList],
...
export default CreditInsuranceBillCollection;
