...
import {GET_qmt_CreditInsuranceBillCollection} from "../../api/tmch.api";
...
const CreditInsuranceBillCollection = () => {
  ...
  const {data, isLoading, isError, error} = useQuery({
    queryKey: ["CreditInsurBillCollModal", from, to],
    queryFn: async () => GET_qmt_CreditInsuranceBillCollection({from, to}),
    enabled: !!from && !!to,
  });
