...
import {GET_TMCH_ProcedureDetails} from "../../api/tmch.api";
import {useQuery} from "@tanstack/react-query";

const ProcedureReportsTmch = () => {
  ...
  useEffect(() => {
    const data = sessionStorage.getItem("ProcedureIpNumberListForTmch");
    if (data) {
  ...
  const {data, isLoading, isError, error} = useQuery({
    queryKey: ["GET_TMCH_ProcedureDetails", from, to, ipList],
    queryFn: async () => GET_TMCH_ProcedureDetails({from, to, ipList}),
...
export default ProcedureReportsTmch;
