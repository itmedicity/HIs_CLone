...
const IncomeReports = () => {
  ...
  return (
    <Box flex={1} sx={{backgroundColor: "lightgray", p: "1%"}}>
      ...
      <MenuButton navigateTo={"hospital_income_imTssh"} />
      <Paper square sx={{borderColor: "black", border: 1}}>
        <ReportHeader name="Hospital Income" data={headerDate} hosName="TRAVANCORE SUPER SPECIALITY HOSPITAL" disable={false} />
        <Box
          sx={{
            overflow: "auto",
            padding: "15px",
