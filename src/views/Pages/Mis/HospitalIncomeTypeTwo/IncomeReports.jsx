...
} from "../../../../Redux-Slice/incomeCollectionTypeSlice/collectionQmtTypeSlice";
import {getProincome1, getProincome2, getProincome3, getProincome4, getPatietTypeDiscount, theaterIncome} from "../../../../Redux-Slice/incomeCollectionTypeSlice/incomeProcedureTypeSlice";
import {getPhaSalePart1, getPhaSalePart2, getPhaSalePart3, getPhaReturnPart1, getPhaReturnPart2, getPhaReturnPart3} from "../../../../Redux-Slice/incomeCollectionTypeSlice/incomeTypeSlice";
...
const IncomeReports = () => {
  ...
  // Redux Selector
  const collection = useSelector((state) => state.collectionQmtType);
  const pharmacyIncome = useSelector((state) => state.pharmacyIncomeQmtType);
  const procedureIncome = useSelector((state) => state.procedureIncomeQmtType);
  ...
  const onClickFuncLevelOne = useCallback(
    async (data) => {
      ...
      const endpoints = {
        BED: "/incomeDetlQmt/bedIncome",
        ROOM: "/incomeDetlQmt/roomRentIncome",
        NS: "/incomeDetlQmt/nsIncome",
        OTHERS: "/incomeDetlQmt/otherIncome",
        CONSULTING: "/incomeDetlQmt/consultingIncome",
        THEATRE: "/incomeDetlQmt/theaterIncome",
        OPERATION: "/incomeDetlQmt/surgeonIncome",
        ANESTHESIA: "/incomeDetlQmt/anesthetiaIncome",
        CARDIOLOGY: "/incomeDetlQmt/cardiologyIncome",
        DISPOSIBLE: "/incomeDetlQmt/disPosibleItemIncome",
        ICU: "/incomeDetlQmt/icuIncome",
        "ICU PROC": "/incomeDetlQmt/icuprocedureIncome",
        RADIOLOGY: "/incomeDetlQmt/radiologyIncome",
        LAB: "/incomeDetlQmt/laboratoryIncome",
        MRI: "/incomeDetlQmt/mriIncome",
        DIET: "/incomeDetlQmt/dietIncome",
      };
  ...
  const getPharmacyDetl = useCallback(async () => {
    ...
    try {
      const [res1, res2, res3, res4] = await Promise.all([
        axiosinstance.post("/incomeDetlQmt/pharmacyIncomePart1", state),
        axiosinstance.post("/incomeDetlQmt/pharmacyIncomePart2", state),
        axiosinstance.post("/incomeDetlQmt/pharmacyIncomePart3", state),
        axiosinstance.post("/incomeDetlQmt/pharmacyIncomePart4", state),
      ]);
  ...
  return (
    <Box flex={1} sx={{backgroundColor: "lightgray", p: "1%"}}>
      <MenuButton navigateTo={"hospital_income_types"} />
