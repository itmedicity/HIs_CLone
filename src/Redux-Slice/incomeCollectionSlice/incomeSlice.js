  ...
  createAsyncThunk(
    ...
    },
    {
      ...
      condition: (_, {getState}) => {
        const state = getState().pharmacyIncome[stateKey];
...
// thuinks
export const getPhaSalePart1 = createApiThunk("phaSalePart1", "phaSalePart1", "phaSalePart1");
export const getPhaReturnPart1 = createApiThunk("phaReturnPart1", "phaReturnPart1", "phaReturnPart1");
export const getPhaSalePart2 = createApiThunk("phaSalePart2", "phaSalePart2", "phaSalePart2");
export const getPhaReturnPart2 = createApiThunk("phaReturnPart2", "phaReturnPart2", "phaReturnPart2");
export const getPhaSalePart3 = createApiThunk("phaSalePart3", "phaSalePart3", "phaSalePart3");
export const getPhaReturnPart3 = createApiThunk("phaReturnPart3", "phaReturnPart3", "phaReturnPart3");
...
const incomeSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    addCases(getPhaSalePart1, "phaSalePart1");
    addCases(getPhaReturnPart1, "phaReturnPart1");
    addCases(getPhaSalePart2, "phaSalePart2");
    addCases(getPhaReturnPart2, "phaReturnPart2");
    addCases(getPhaSalePart3, "phaSalePart3");
    addCases(getPhaReturnPart3, "phaReturnPart3");
  },
});

export const {resetPharmacyIncomeState} = incomeSlice.actions;
